...
def export_manual_ai_inputs(
    ...
    """Export realtime stock JSON + prompts for manual AI usage, without invoking LLM."""
    ...
    logger.info("手动提问输入已导出: %s, %s, %s", stock_json_path, stock_prompt_path, market_prompt_path)
